...
if (@constant('IPS_BASE') == null) {
    ...
    define('KR_READY', IPS_KERNELMESSAGE + 3); // Kernel ist bereit und l�uft
    ...
    define('KL_NOTIFY', IPS_LOGMESSAGE + 3); // �nderungsbenachrichtung
    ...
    define('OM_CHANGEPARENT', IPS_OBJECTMESSAGE + 3); // �bergeordnetes Objekt hat sich ge�ndert
    define('OM_CHANGENAME', IPS_OBJECTMESSAGE + 4); // Name hat sich ge�ndert
    define('OM_CHANGEINFO', IPS_OBJECTMESSAGE + 5); // Info hat sich ge�ndert
    define('OM_CHANGETYPE', IPS_OBJECTMESSAGE + 6); // Typ hat sich ge�ndert
    define('OM_CHANGESUMMARY', IPS_OBJECTMESSAGE + 7); // Kurzinfo hat sich ge�ndert
    define('OM_CHANGEPOSITION', IPS_OBJECTMESSAGE + 8); // Position hat sich ge�ndert
    define('OM_CHANGEREADONLY', IPS_OBJECTMESSAGE + 9); // "Nur-Lesen"-Status hat sich ge�ndert
    define('OM_CHANGEHIDDEN', IPS_OBJECTMESSAGE + 10); // Sichtbarkeit hat sich ge�ndert
    define('OM_CHANGEICON', IPS_OBJECTMESSAGE + 11); // Icon hat sich ge�ndert
    define('OM_CHILDADDED', IPS_OBJECTMESSAGE + 12); // Untergeordnetes Objekt hinzugef�gt
    define('OM_CHILDREMOVED', IPS_OBJECTMESSAGE + 13); // Untergeordnetes Objekt entfernt
    define('OM_CHANGEIDENT', IPS_OBJECTMESSAGE + 14); // Ident hat sich ge�ndert
    define('OM_CHANGEDISABLED', IPS_OBJECTMESSAGE + 15); // Ident hat sich ge�ndert
    ...
    define('IM_CONNECT', IPS_INSTANCEMESSAGE + 3); // Instanzinterface verf�gbar
    define('IM_DISCONNECT', IPS_INSTANCEMESSAGE + 4); // Instanzinterface nicht mehr verf�gbar
    define('IM_CHANGESTATUS', IPS_INSTANCEMESSAGE + 5); // Status hat sich ge�ndert
    define('IM_CHANGESETTINGS', IPS_INSTANCEMESSAGE + 6); // Einstellungen haben sich ge�ndert
    ...
    define('VM_CHANGEPROFILENAME', IPS_VARIABLEMESSAGE + 4); // Variablenprofilname wurde ge�ndert
    define('VM_CHANGEPROFILEACTION', IPS_VARIABLEMESSAGE + 5); // Variablenprofilaktion wurde ge�ndert
    ...
    define('SM_BROKEN', IPS_SCRIPTMESSAGE + 4); // Skript Fehlerstatus hat sich ge�ndert
    ...
    define('EM_CHANGEACTIVE', IPS_EVENTMESSAGE + 4); // Ereignisaktivierung hat sich ge�ndert
    define('EM_CHANGELIMIT', IPS_EVENTMESSAGE + 5); // Ereignisaufruflimit hat sich ge�ndert
    define('EM_CHANGESCRIPT', IPS_EVENTMESSAGE + 6); // Ereignisskriptinhalt hat sich ge�ndert
    define('EM_CHANGETRIGGER', IPS_EVENTMESSAGE + 7); // Ereignisausl�ser hat sich ge�ndert
    define('EM_CHANGETRIGGERVALUE', IPS_EVENTMESSAGE + 8); // Ereignisgrenzwert hat sich ge�ndert
    define('EM_CHANGETRIGGEREXECUTION', IPS_EVENTMESSAGE + 9); // Ereignisgrenzwertausl�sung hat sich ge�ndert
    define('EM_CHANGECYCLIC', IPS_EVENTMESSAGE + 10); // Zyklisches Ereignis hat sich ge�ndert
    define('EM_CHANGECYCLICDATEFROM', IPS_EVENTMESSAGE + 11); // Startdatum hat sich ge�ndert
    define('EM_CHANGECYCLICDATETO', IPS_EVENTMESSAGE + 12); // Enddatum hat sich ge�ndert
    define('EM_CHANGECYCLICTIMEFROM', IPS_EVENTMESSAGE + 13); // Startzeit hat sich ge�ndert
    define('EM_CHANGECYCLICTIMETO', IPS_EVENTMESSAGE + 14); // Endzeit hat sich ge�ndert
    define('EM_ADDSCHEDULEACTION', IPS_EVENTMESSAGE + 15); // Eintrag in der Aktionstabelle des Wochenplans wurde hinzugef�gt
    define('EM_REMOVESCHEDULEACTION', IPS_EVENTMESSAGE + 16); // Eintrag in der Aktionstabelle des Wochenplans wurde entfernt
    define('EM_CHANGESCHEDULEACTION', IPS_EVENTMESSAGE + 17); // Eintrag in der Aktionstabelle des Wochenplans hat sich ge�ndert
    define('EM_ADDSCHEDULEGROUP', IPS_EVENTMESSAGE + 18); // Gruppierung der Wochenplantage wurde hinzugef�gt
    define('EM_REMOVESCHEDULEGROUP', IPS_EVENTMESSAGE + 19); // Gruppierung der Wochenplantage wurde entfernt
    define('EM_CHANGESCHEDULEGROUP', IPS_EVENTMESSAGE + 20); // Gruppierung der Wochenplantage hat sich ge�ndert
    define('EM_ADDSCHEDULEGROUPPOINT', IPS_EVENTMESSAGE + 21); // Schaltpunkt einer Gruppierung wurde hinzugef�gt
    define('EM_REMOVESCHEDULEGROUPPOINT', IPS_EVENTMESSAGE + 22); // Schaltpunkt einer Gruppierung wurde entfernt
    define('EM_CHANGESCHEDULEGROUPPOINT', IPS_EVENTMESSAGE + 23); // Schaltpunkt einer Gruppierung hat sich ge�ndert
    ...
    define('MM_CHANGEFILE', IPS_MEDIAMESSAGE + 3); // Datei des Medienobjekts wurde ge�ndert
    define('MM_AVAILABLE', IPS_MEDIAMESSAGE + 4); // Verf�gbarkeit des Medienobjekts hat sich ge�ndert
    define('MM_UPDATE', IPS_MEDIAMESSAGE + 5); // Medienobjekt wurde aktualisiert
    define('MM_CHANGECACHED', IPS_MEDIAMESSAGE + 6); // Cacheoption vom Medienobjekt hat sich ge�ndert
    ...
    define('LM_CHANGETARGET', IPS_LINKMESSAGE + 3); // Ziel des Links hat sich ge�ndert
    ...
    define('SE_EXECUTE', IPS_ENGINEMESSAGE + 2); // Script wurde ausgef�hrt
    define('SE_RUNNING', IPS_ENGINEMESSAGE + 3); // Script wird ausgef�hrt
    ...
    define('PM_CHANGETEXT', IPS_PROFILEMESSAGE + 3); // Profilprefix/Profilsuffix hat sich ge�ndert
    define('PM_CHANGEVALUES', IPS_PROFILEMESSAGE + 4); // Profilwerte haben sich ge�ndert
    define('PM_CHANGEDIGITS', IPS_PROFILEMESSAGE + 5); // Profilnachkommastellen haben sich ge�ndert
    define('PM_CHANGEICON', IPS_PROFILEMESSAGE + 6); // Profilicon hat sich ge�ndert
    define('PM_ASSOCIATIONADDED', IPS_PROFILEMESSAGE + 7); // Profilassoziation wurde hinzugef�gt
    define('PM_ASSOCIATIONREMOVED', IPS_PROFILEMESSAGE + 8); // Profilassoziation wurde entfernt
    define('PM_ASSOCIATIONCHANGED', IPS_PROFILEMESSAGE + 9); // Profilassoziation hat sich ge�ndert
    ...
    define('TM_SETINTERVAL', IPS_TIMERMESSAGE + 3); // Timer Interval hat sich ge�ndert
    define('TM_UPDATE', IPS_TIMERMESSAGE + 4); // Timer Fortschritt hat sich ge�ndert
...
if (@constant('IS_SBASE') == null) {
    ...
    define('IS_DELETING', IS_SBASE + 3); // Instanz wird gel�scht
